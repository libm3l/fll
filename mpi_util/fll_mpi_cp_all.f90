...
!  Send node header
!
   CALL MPI_BCAST(IARR, 5, MPI_INTEGER8, SENDPART,COMMUNICATOR, IERR)
...
!
     IF(ASSOCIATED(PNODE%R3))THEN
       CALL MPI_BCAST(PNODE%R3, NDIM*NSIZE*NSIZE1, MPI_REAL, SENDPART,COMMUNICATOR, IERR)
      RETURN     
     END IF
     IF(ASSOCIATED(PNODE%D3))THEN
      CALL MPI_BCAST(PNODE%D3, NDIM*NSIZE*NSIZE1, MPI_DOUBLE, SENDPART,COMMUNICATOR, IERR)
       RETURN     
     END IF
     IF(ASSOCIATED(PNODE%I3))THEN
       CALL MPI_BCAST(PNODE%I3, NDIM*NSIZE*NSIZE1, MPI_INTEGER, SENDPART,COMMUNICATOR, IERR)
       RETURN     
     END IF
     IF(ASSOCIATED(PNODE%L3))THEN
       CALL MPI_BCAST(PNODE%L3, NDIM*NSIZE*NSIZE1, MPI_INTEGER8,SENDPART, COMMUNICATOR, IERR)
       RETURN     
     END IF
!     IF(ASSOCIATED(PNODE%S3))THEN
!       CALL MPI_BCAST(PNODE%S3, NDIM*NSIZE*NSIZE1*NAME_LENGTH, MPI_CHARACTER,SENDPART, COMMUNICATOR, IERR)
!       RETURN     
!     END IF
!
! 4D ARRAYS
!
     IF(ASSOCIATED(PNODE%R4))THEN
       CALL MPI_BCAST(PNODE%R4, NDIM*NSIZE*NSIZE1*NSIZE2, MPI_REAL, SENDPART,COMMUNICATOR, IERR)
      RETURN     
     END IF
     IF(ASSOCIATED(PNODE%D4))THEN
      CALL MPI_BCAST(PNODE%D4, NDIM*NSIZE*NSIZE1*NSIZE2, MPI_DOUBLE, SENDPART,COMMUNICATOR, IERR)
       RETURN     
     END IF
     IF(ASSOCIATED(PNODE%I4))THEN
       CALL MPI_BCAST(PNODE%I4, NDIM*NSIZE*NSIZE1*NSIZE2, MPI_INTEGER, SENDPART,COMMUNICATOR, IERR)
       RETURN     
     END IF
     IF(ASSOCIATED(PNODE%L4))THEN
       CALL MPI_BCAST(PNODE%L4, NDIM*NSIZE*NSIZE1*NSIZE2, MPI_INTEGER8,SENDPART, COMMUNICATOR, IERR)
       RETURN     
     END IF
!     IF(ASSOCIATED(PNODE%S4))THEN
!       CALL MPI_BCAST(PNODE%S4, NDIM*NSIZE*NSIZE1*NSIZE2*NAME_LENGTH, MPI_CHARACTER,SENDPART, COMMUNICATOR, IERR)
!       RETURN     
!     END IF
!
...
!
     ...
     END IF
     IF(ASSOCIATED(PNODE%I3))THEN
       CALL MPI_BCAST(PNODE%I3, NDIM*NSIZE, MPI_INTEGER,SENDPART, COMMUNICATOR, IERR)
       RETURN     
     END IF
     IF(ASSOCIATED(PNODE%L3))THEN
       CALL MPI_BCAST(PNODE%L3, NDIM*NSIZE*NSIZE1, MPI_INTEGER8,SENDPART, COMMUNICATOR, IERR)
