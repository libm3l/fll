...
!
    VECSCAL: IF(NDIM > 1)THEN
      ...
      IF(PRESENT(R1))THEN
       ...
       IF(ISTAT /= 0)THEN
        WRITE(*,*)'ERROR ALLOCATING MEMORY ==> fll_mpi_sum ERR:111 '
        STOP
      END IF
       TR1 = R1
       ...
       IF(ISTAT /= 0)THEN
        WRITE(*,*)'ERROR ALLOCATING MEMORY ==> fll_mpi_sum ERR:118 '
        STOP
      END IF
       RETURN 
      END IF
      ...
      IF(PRESENT(D1))THEN
       ...
       IF(ISTAT /= 0)THEN
        WRITE(*,*)'ERROR ALLOCATING MEMORY ==> fll_mpi_sum ERR:127 '
        STOP
      END IF
       TD1 = D1
       ...
       IF(ISTAT /= 0)THEN
        WRITE(*,*)'ERROR ALLOCATING MEMORY ==> fll_mpi_sum ERR:134 '
        STOP
      END IF
       RETURN 
      END IF
      ...
      IF(PRESENT(I1))THEN
       ...
       IF(ISTAT /= 0)THEN
        WRITE(*,*)'ERROR ALLOCATING MEMORY ==> fll_mpi_sum ERR:143 '
        STOP
      END IF
       TI1 = I1
       ...
       IF(ISTAT /= 0)THEN
        WRITE(*,*)'ERROR ALLOCATING MEMORY ==> fll_mpi_sum ERR:150 '
        STOP
      END IF
       RETURN 
      END IF
      ...
      IF(PRESENT(L1))THEN
       ...
       IF(ISTAT /= 0)THEN
        WRITE(*,*)'ERROR ALLOCATING MEMORY ==> fll_mpi_sum ERR:159 '
        STOP
      END IF
       TL1 = L1
       ...
       IF(ISTAT /= 0)THEN
        WRITE(*,*)'ERROR ALLOCATING MEMORY ==> fll_mpi_sum ERR:166 '
        STOP
      END IF
       RETURN 
      END IF
