...
!
CONTAINS
  FUNCTION FLL_GETNDATA_R0(PNODE,NAME,NUMBER,FPAR,ERRMSG,SETDIM,&
      DIAGMESSG) RESULT(R0)
!
...
!
   ...
   INTEGER(LINT) :: NUMBER
   REAL(RSINGLE) :: R0
   CHARACTER(*), OPTIONAL :: ERRMSG,SETDIM,DIAGMESSG
!
! local declarations
!
...
!
  ...
  FUNCTION FLL_GETNDATA_R1(PNODE,NAME,NUMBER,FPAR,ERRMSG,SETDIM,DIAGMESSG) RESULT(R1)
!
! Description: returns single real data of the node
!
! 
...
!
  ...
  FUNCTION FLL_GETNDATA_R2(PNODE,NAME,NUMBER,FPAR,ERRMSG,SETDIM,DIAGMESSG) RESULT(R2)
!
! Description: returns single real data of the node
!
! 
...
!
  ...
  FUNCTION FLL_GETNDATA_R3(PNODE,NAME,NUMBER,FPAR,ERRMSG,SETDIM,DIAGMESSG) RESULT(R3)
!
! Description: returns single real data of the node
!
! 
...
!
  ...
  FUNCTION FLL_GETNDATA_R4(PNODE,NAME,NUMBER,FPAR,ERRMSG,SETDIM,DIAGMESSG) RESULT(R4)
!
! Description: returns single real data of the node
!
! 
...
!  DOUBLE
!
  FUNCTION FLL_GETNDATA_D0(PNODE,NAME,NUMBER,FPAR,ERRMSG,SETDIM,DIAGMESSG) RESULT(R0)
!
! Description: returns single real data of the node
!
! 
...
!
  ...
  FUNCTION FLL_GETNDATA_D1(PNODE,NAME,NUMBER,FPAR,ERRMSG,SETDIM,DIAGMESSG) RESULT(R1)
!
! Description: returns single real data of the node
!
! 
...
!
  ...
  FUNCTION FLL_GETNDATA_D2(PNODE,NAME,NUMBER,FPAR,ERRMSG,SETDIM,DIAGMESSG) RESULT(R2)
!
! Description: returns single real data of the node
!
! 
...
!
  ...
  FUNCTION FLL_GETNDATA_D3(PNODE,NAME,NUMBER,FPAR,ERRMSG,SETDIM,DIAGMESSG) RESULT(R3)
!
! Description: returns single real data of the node
!
! 
...
!
  ...
  FUNCTION FLL_GETNDATA_D4(PNODE,NAME,NUMBER,FPAR,ERRMSG,SETDIM,DIAGMESSG) RESULT(R4)
!
! Description: returns single real data of the node
!
! 
...
!  INTEGER
!
  FUNCTION FLL_GETNDATA_I0(PNODE,NAME,NUMBER,FPAR,ERRMSG,SETDIM,DIAGMESSG) RESULT(I0)
!
! Description: returns single real data of the node
!
! 
...
!
  ...
  FUNCTION FLL_GETNDATA_I1(PNODE,NAME,NUMBER,FPAR,ERRMSG,SETDIM,DIAGMESSG) RESULT(I1)
!
! Description: returns single real data of the node
!
! 
...
!
  ...
  FUNCTION FLL_GETNDATA_I2(PNODE,NAME,NUMBER,FPAR,ERRMSG,SETDIM,DIAGMESSG) RESULT(I2)
!
! Description: returns single real data of the node
!
! 
...
!
 ...
 FUNCTION FLL_GETNDATA_I3(PNODE,NAME,NUMBER,FPAR,ERRMSG,SETDIM,DIAGMESSG) RESULT(I3)
!
! Description: returns single real data of the node
!
! 
...
!
 ...
 FUNCTION FLL_GETNDATA_I4(PNODE,NAME,NUMBER,FPAR,ERRMSG,SETDIM,DIAGMESSG) RESULT(I4)
!
! Description: returns single real data of the node
!
! 
...
!  LONG INTEGER
!
  FUNCTION FLL_GETNDATA_L0(PNODE,NAME,NUMBER,FPAR,ERRMSG,SETDIM,DIAGMESSG) RESULT(I0)
!
! Description: returns single real data of the node
!
! 
...
!
  ...
  FUNCTION FLL_GETNDATA_L1(PNODE,NAME,NUMBER,FPAR,ERRMSG,SETDIM,DIAGMESSG) RESULT(I1)
...
!
 ...
 END IF
  ...
  FUNCTION FLL_GETNDATA_L2(PNODE,NAME,NUMBER,FPAR,ERRMSG,SETDIM,DIAGMESSG) RESULT(I2)
!
! Description: returns single real data of the node
!
! 
...
!
  ...
  FUNCTION FLL_GETNDATA_L3(PNODE,NAME,NUMBER,FPAR,ERRMSG,SETDIM,DIAGMESSG) RESULT(I3)
!
! Description: returns single real data of the node
!
! 
...
!
  ...
  FUNCTION FLL_GETNDATA_L4(PNODE,NAME,NUMBER,FPAR,ERRMSG,SETDIM,DIAGMESSG) RESULT(I4)
!
! Description: returns single real data of the node
!
! 
...
!
  ...
  FUNCTION FLL_GETNDATA_S0(PNODE,NAME,NUMBER,FPAR,ERRMSG,SETDIM,DIAGMESSG) RESULT(STRING)
!
! Description: returns single real data of the node
!
! 
...
FUNCTION FLL_GETNDATA_S1(PNODE,NAME,NUMBER,FPAR,ERRMSG,SETDIM,DIAGMESSG) RESULT(STRING)
!
! Description: returns single real data of the node
!
! 
...
!
  ...
  FUNCTION FLL_GETNDATA_S2(PNODE,NAME,NUMBER,FPAR,ERRMSG,SETDIM,DIAGMESSG) RESULT(STRING)
!
! Description: returns single real data of the node
!
! 
