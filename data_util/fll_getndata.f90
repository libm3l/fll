...
!
  ...
  FUNCTION FLL_GETNDATA_R3(PNODE,NAME,NUMBER,FPAR,ERRMSG,FORCE_TYPE) RESULT(R3)
!
! Description: returns single real data of the node
!
! 
...
!
   ...
   IF(.NOT.ASSOCIATED(PNODE))THEN
      FPAR%SUCCESS = .FALSE.
      WRITE(FPAR%MESG,'(A)')'FLL_GETNDATA_R3 - Null node '
  ...
  FUNCTION FLL_GETNDATA_R4(PNODE,NAME,NUMBER,FPAR,ERRMSG,FORCE_TYPE) RESULT(R4)
!
! Description: returns single real data of the node
!
! 
...
!
   ...
   IF(.NOT.ASSOCIATED(PNODE))THEN
      FPAR%SUCCESS = .FALSE.
      WRITE(FPAR%MESG,'(A)')'FLL_GETNDATA_R4 - Null node '
...
!
  ...
  FUNCTION FLL_GETNDATA_D3(PNODE,NAME,NUMBER,FPAR,ERRMSG,FORCE_TYPE) RESULT(R3)
!
! Description: returns single real data of the node
!
! 
...
!
   ...
   IF(.NOT.ASSOCIATED(PNODE))THEN
      FPAR%SUCCESS = .FALSE.
      WRITE(FPAR%MESG,'(A)')'FLL_GETNDATA_D3 - Null node '
      CALL FLL_OUT(LOC_ERRMSG,FPAR)
      RETURN      
   END IF
  ...
  FUNCTION FLL_GETNDATA_D4(PNODE,NAME,NUMBER,FPAR,ERRMSG,FORCE_TYPE) RESULT(R4)
!
! Description: returns single real data of the node
!
! 
...
!
   ...
   IF(.NOT.ASSOCIATED(PNODE))THEN
      FPAR%SUCCESS = .FALSE.
      WRITE(FPAR%MESG,'(A)')'FLL_GETNDATA_D4 - Null node '
      CALL FLL_OUT(LOC_ERRMSG,FPAR)
      RETURN      
   END IF
...
!
 ...
 FUNCTION FLL_GETNDATA_I3(PNODE,NAME,NUMBER,FPAR,ERRMSG,FORCE_TYPE) RESULT(I3)
!
! Description: returns single real data of the node
!
! 
...
!
   ...
   IF(.NOT.ASSOCIATED(PNODE))THEN
      FPAR%SUCCESS = .FALSE.
      WRITE(FPAR%MESG,'(A)')'FLL_GETNDATA_I3 - Null node '
      CALL FLL_OUT(LOC_ERRMSG,FPAR)
      RETURN      
   END IF
 ...
 FUNCTION FLL_GETNDATA_I4(PNODE,NAME,NUMBER,FPAR,ERRMSG,FORCE_TYPE) RESULT(I4)
!
! Description: returns single real data of the node
!
! 
...
!
   ...
   IF(.NOT.ASSOCIATED(PNODE))THEN
      FPAR%SUCCESS = .FALSE.
      WRITE(FPAR%MESG,'(A)')'FLL_GETNDATA_I4 - Null node '
      CALL FLL_OUT(LOC_ERRMSG,FPAR)
      RETURN      
   END IF
...
!
  ...
  FUNCTION FLL_GETNDATA_L3(PNODE,NAME,NUMBER,FPAR,ERRMSG,FORCE_TYPE) RESULT(I3)
!
! Description: returns single real data of the node
!
! 
...
!
   ...
   IF(.NOT.ASSOCIATED(PNODE))THEN
      FPAR%SUCCESS = .FALSE.
      WRITE(FPAR%MESG,'(A)')'FLL_GETNDATA_L3 - Null node '
      CALL FLL_OUT(LOC_ERRMSG,FPAR)
      RETURN      
   END IF
  ...
  FUNCTION FLL_GETNDATA_L4(PNODE,NAME,NUMBER,FPAR,ERRMSG,FORCE_TYPE) RESULT(I4)
!
! Description: returns single real data of the node
!
! 
...
!
   ...
   IF(.NOT.ASSOCIATED(PNODE))THEN
      FPAR%SUCCESS = .FALSE.
      WRITE(FPAR%MESG,'(A)')'FLL_GETNDATA_L4 - Null node '
      CALL FLL_OUT(LOC_ERRMSG,FPAR)
      RETURN      
   END IF
