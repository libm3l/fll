...
CONTAINS
  ...
  FUNCTION FLL_READ_RECORD(FILE,IOUNIT,PLIST,NAME,LTYPE,DATADIM,NUMBER,&
      RECURSE,FPAR,ERRMSG,DIAGMESSG) RESULT(PNODE)
!
...
!   READ INITIAL NODE
!
   PLIST => READ_NODE(IOUNIT,FMT_LOC,POS,SCAN_LOC,FPAR,LOC_ERRMSG)
   IF(.NOT.ASSOCIATED(PLIST)) THEN
